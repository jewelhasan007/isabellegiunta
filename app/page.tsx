...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="instagram-strip"><div><p className="section-kicker">More from the studio</p><h2>Follow<br /><em>the glam.</em></h2></div><div className="instagram-copy"><p>Latest looks, behind-the-scenes moments and beauty inspiration, over on Instagram.</p><a href="https://www.instagram.com/onsetwithisabelle/" target="_blank" rel="noreferrer" className="button button-light">@onsetwithisabelle <Instagram size={16} /></a></div><div className="instagram-images"><Image src="/images/studio/photo018.png" alt="Isabelle Giunta Instagram portfolio" fill sizes="25vw" className="cover-image" /><div className="instagram-note">See you<br />over there <ArrowUpRight size={17} /></div></div></section>
